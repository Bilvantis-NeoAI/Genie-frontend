...
import {
  ...
  addAiCsvData,
  clearAiTestCaseData,
} from "../actions/aiTestCasesActions";
      ...
      <div className="card top-div mt-2 pb-5">
        ...
        <div className="col-12 d-flex ">
          <div className="dropzone">
            <DropzoneSection
              title={
                <span className="dropzone-title">Upload Feature Files</span>
              }
            ...
            <DropzoneSection
              title={
                <span className="dropzone-title">
                  Upload OpenAPI Config/Backend Files
                </span>
              }
              ...
              <table className="table table-bordered w-100">
                ...
                <tbody>
                  {tableData.map((row, rowIndex) => (
                    <tr
                      key={row.id}
                      className={row.isSelected ? "table-active" : ""}
                    >
                      <td
