      ...
      >
        <Card className="p-4 shadow-sm rounded release-form-card">
          ...
          <Row className="mb-3">
            ...
            <Col xs={12} md={4}>
              <Form.Group controlId="oldBranch">
                <Form.Label>
                  Old Branch <span className="text-danger">*</span>
                </Form.Label>
                <Form.Control
                  type="text"
            ...
            <Col xs={12} md={4}>
              <Form.Group controlId="newBranch">
                <Form.Label>
                  New Branch <span className="text-danger">*</span>
                </Form.Label>
                <Form.Control
                  type="text"
          ...
          <Row className="mb-4">
            ...
            <Col xs={12} md={8}>
              <Form.Group controlId="uploadFile">
                <Form.Label>
                  Upload Features (CSV) <span className="text-danger">*</span>
                </Form.Label>
                <Form.Control
                  type="file"
                  accept=".csv"
                          ...
                          {Object.entries(row).map(([field, value]) => (
                            <td key={field}>
                              <input
                                ...
                                className="form-control form-control-sm csv-cell-input"
                              />
                            </td>
                          ))}
                        </tr>
          ...
          <Button
            ...
            className="btn btn-primary btn-sm mb-4 px-3 fixed-size-btn"
          >
            Submit
          </Button>
            ...
            <Row className="g-4 mt-3">
              <Col lg={9}>
                <Card className="p-3 bg-light border">
                  ...
                  <textarea
                    className="form-control bg-dark text-white fixed-textarea"
                    rows="10"
                    readOnly
                    value={releaseNotes}
                  ...
                  <Button
                    onClick={() =>
                      handleDownload(releaseNotes, "release_notes.txt")
                    }
            ...
            <Row className="g-4 mt-5">
              <Col lg={9}>
                <Card className="p-3 bg-light border">
                  ...
                  <Button
                    onClick={() =>
                      handleDownload(commitLogs, "commit_logs_summary.txt")
                    }
                    className="btn btn-primary w-100 mt-3"
                  >
                    ⬇ Download Commit Logs
                  </Button>
                </Card>
              </Col>
