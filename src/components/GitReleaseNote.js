                                ...
                                <div className="table-responsive">
                                    <table className="table table-bordered table-sm">
                                        <thead className="table-light">
                                            <tr>{Object.keys(csvData[0]).map((header) => <th key={header}>{header}</th>)}</tr>
                                        </thead>
                                        <tbody>
                            ...
                            <Row className="g-4 mt-3">
                                <Col lg={9}>
                                    <Card className="p-3 bg-light border">
                                        ...
                                        <textarea className="bg-dark text-white" rows="10" readOnly value={releaseNotes} />
                                ...
                                <Col lg={3}>
                                    <Card className="p-3 bg-white border">
                                        ...
                                        <textarea className="" rows="10" value={releaseNotesFeedback} onChange={(e) => setReleaseNotesFeedback(e.target.value)} />
                            ...
                            <Row className="g-4 mt-5">
                                <Col lg={9}>
                                    <Card className="p-3 bg-light border">
                                        ...
                                        <textarea className="bg-dark text-white" rows="10" readOnly value={commitLogs} />
